    ...
    d3.json(beaches_url)
        ...
        for (var i = 0; i < data[0].length; i++) {
            ...
            markers.push(L.marker([beachdata[i].latitude, beachdata[i].longitude])
                .bindPopup("<h4>Beach Name: " + beachdata[i].beach_name + "</h4><hr><p>" + beachdata[i].address + ", " + beachdata[i].city + ", " + beachdata[i].state + " " + beachdata[i].zip + "</p>" + "<p><b>Activities: " +  beachdata[i].activities + "</p>" + "<p><b>Amenities: " + beachdata[i].amenities + "<b></p>"));
