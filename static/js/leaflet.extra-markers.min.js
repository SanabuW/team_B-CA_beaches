    ...
    (L.ExtraMarkers.Icon = L.Icon.extend({
      ...
      createIcon: function () {
        var a = b.createElement("div"),
          c = this.options;
        return (
          c.icon && (a.innerHTML = this._createInner()),
          c.innerHTML && (a.innerHTML = c.innerHTML),
          c.bgPos &&
            (a.style.backgroundPosition =
              -c.bgPos.x + "px " + -c.bgPos.y + "px"),
          this._setIconStyles(a, c.shape + "-" + c.markerColor),
          a
        );
      },
      _createInner: function () {
        var a = "",
          ...
          c = this.options;
        return (
          c.iconColor && (a = "style='position: relative; top: 10px; left: 1px; color: " + c.iconColor + "' "),
      ...
      _setIconStyles: function (a, b) {
        ...
        "shadow" === b
          ? ((c = L.point(e.shadowAnchor || e.iconAnchor)), (d = "shadow"))
          : ((c = L.point(e.iconAnchor)), (d = "icon")),
          !c && f && (c = f.divideBy(2, !0)),
          (a.className =
            "leaflet-marker-" + d + " extra-marker-" + b + " " + e.className),
          c &&
            ((a.style.marginLeft = -c.x + "px"),
